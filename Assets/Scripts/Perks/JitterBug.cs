...
public class JitterBug : PerkBase
{
    ...
    [SerializeField] AudioClip upgradedRockThrownSound;
    ...
    public override void PerkUpgrade2(){
        ...
        controller.GetComponent<WeaponController>().rockThrownSound = upgradedRockThrownSound;
